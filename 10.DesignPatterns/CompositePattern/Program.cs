namespace CompositePattern
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Rectangle rectangle = new Rectangle(5, new Position(10, 5));
            Rectangle rectangle2 = new Rectangle(8, new Position(22, 3));
            Rectangle rectangle3 = new Rectangle(5, new Position(40, 5));
